...
namespace WebApplication1.Controllers
{
    public class CarWorkshopController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nazwa,Opis,Adres,Telefon")] CarWorkshopEntity carWorkshopEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nazwa,Opis,Adres,Telefon")] CarWorkshopEntity carWorkshopEntity)
        {
